...
vi.mock('grammy', () => ({
  Bot: class MockBot {
    ...
    api = {
      // Production code reads `msg.message_id` / `msg.date` after sendMessage.
      // Returning undefined (old mock) crashed the split-loop after the first
      // call. Mirror a minimal real response shape.
